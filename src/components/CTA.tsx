  ...
  return (
    <section className="py-20 sm:py-24 md:py-32 lg:py-40 bg-cream relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Corner decorations */}
        <div className="absolute top-12 left-12 w-20 h-20 border-t border-l border-accent/15 hidden lg:block" />
      ...
      <div className="max-w-4xl mx-auto px-5 sm:px-6 md:px-8 lg:px-12 xl:px-16 relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.a
              href="#contacto"
              className="group inline-flex items-center justify-center gap-3 px-10 py-5 bg-primary-deeper text-white text-sm font-semibold tracking-wide uppercase hover:bg-primary-dark transition-all duration-300"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.98 }}
            >
            ...
            <motion.a
              ...
              className="inline-flex items-center justify-center gap-3 px-10 py-5 border border-primary-deeper/20 text-primary-deeper text-sm tracking-wide uppercase hover:border-accent hover:text-accent transition-all duration-300"
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.98 }}
            >
