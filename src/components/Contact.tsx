    ...
    <section id="contacto" className="py-24 lg:py-32 bg-white relative noise">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-20">
          ...
          >
            ...
            <div className="space-y-8 mb-12 flex flex-col items-center">
              {contactDetails.map((detail, index) => (
                ...
                >
                  <div className="w-12 h-12 border border-accent/20 flex items-center justify-center flex-shrink-0 bg-accent/5 rounded-full">
                  ...
                  <div>
                    ...
                    {detail.lines.map((line, i) => (
                      <p key={i} className="text-slate/80 text-base leading-relaxed">
                        {detail.href ? (
            ...
            >
              ...
              <a
                ...
                className="group inline-flex items-center gap-3 text-slate/80 hover:text-accent transition-colors bg-white border border-warm-gray px-6 py-3 rounded-full hover:border-accent hover:bg-accent/5"
              >
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8 bg-white p-8 sm:p-10 border border-warm-gray/30 shadow-sm rounded-sm">
              ...
              {submitted && (
                <motion.div
                  ...
                  className="mt-6 p-5 border border-accent/20 bg-accent/5 rounded-sm"
                >
                  <div className="flex items-center justify-center gap-3">
                    <div className="w-8 h-8 bg-accent/10 flex items-center justify-center flex-shrink-0 rounded-full">
                      <svg className="w-4 h-4 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <div>
                      <p className="text-primary-deeper font-semibold text-sm text-center">Mensaje enviado</p>
                      <p className="text-slate/80 text-xs text-center">Nos pondremos en contacto pronto.</p>
                    </div>
                  </div>
                </motion.div>
              )}
